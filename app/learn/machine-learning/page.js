...
const mlModules = [
  {
    ...
    lessons: [
      ...
      { id: 'ml-1-3', name: 'Supervised vs Unsupervised Learning', nodeType: 'concept', status: 'completed' },
      { id: 'ml-1-4', name: 'Regression vs Classification', nodeType: 'concept', status: 'completed' },
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: 'ml-3-5', name: 'Gradient Descent', nodeType: 'star', status: 'active' },
      { id: 'ml-3-6', name: 'Mean Squared Error (MSE)', nodeType: 'concept', status: 'active' },
      { id: 'ml-3-7', name: 'Mean Absolute Error (MAE)', nodeType: 'concept', status: 'active' },
      { id: 'ml-3-8', name: 'R-Squared (R²)', nodeType: 'concept', status: 'active' },
      { id: 'ml-3-p1', name: 'Mini Project: Predict Salaries', nodeType: 'project', status: 'active', isProject: true },
    ]
  },
  {
    id: 4,
    ...
    lessons: [
      ...
      { id: 'ml-4-5', name: 'Decision Trees', nodeType: 'concept', status: 'active' },
      { id: 'ml-4-6', name: 'Random Forest', nodeType: 'star', status: 'active' },
      { id: 'ml-4-7', name: 'Accuracy, Precision, Recall & F1', nodeType: 'concept', status: 'active' },
      { id: 'ml-4-8', name: 'Confusion Matrix & ROC-AUC', nodeType: 'concept', status: 'active' },
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: 'ml-6-5', name: 'Feature Selection', nodeType: 'concept', status: 'active' },
      { id: 'ml-6-6', name: 'Feature Engineering', nodeType: 'star', status: 'active' },
      { id: 'ml-6-7', name: 'Handling Imbalanced Datasets', nodeType: 'concept', status: 'active' },
      { id: 'ml-6-8', name: 'Data Leakage', nodeType: 'concept', status: 'active' },
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: 'ml-7-6', name: 'Stacking (Stacked Generalization & Blending)', nodeType: 'concept', status: 'active' },
      { id: 'ml-7-7', name: 'Comparative Strategy & Model Evaluation', nodeType: 'concept', status: 'active' },
      { id: 'ml-7-p1', name: 'Mini Project: High-Performance Ensemble Model', nodeType: 'project', status: 'locked', isProject: true },
    ]
  },
  {
    id: 8,
    title: 'Module 8: The ML Workflow (End-to-End Project)',
    subtitle: 'Goal: Master the complete 7-stage ML project lifecycle with Telecom Churn Retention.',
    lessons: [
      { id: 'ml-8-1', name: 'Problem Definition & Business Framing', nodeType: 'concept', status: 'active' },
      { id: 'ml-8-2', name: 'Data Ingestion & Exploratory Data Analysis', nodeType: 'star', status: 'active' },
      { id: 'ml-8-3', name: 'Data Cleaning & Feature Engineering Pipelines', nodeType: 'concept', status: 'active' },
      { id: 'ml-8-4', name: 'Model Training & Baseline Tournament', nodeType: 'lightbulb', status: 'active' },
      { id: 'ml-8-5', name: 'Hyperparameter Optimization (Optuna Tuning)', nodeType: 'concept', status: 'active' },
      { id: 'ml-8-6', name: 'Model Evaluation, Packaging & Model Card', nodeType: 'star', status: 'active' },
      { id: 'ml-8-7', name: 'Production Serving, FastAPI & ROI Audit', nodeType: 'flag', status: 'active' },
      { id: 'ml-8-p1', name: 'Capstone Project: Telecom Churn Retention Engine', nodeType: 'project', status: 'locked', isProject: true },
    ]
  },
  {
    id: 9,
